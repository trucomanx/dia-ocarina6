...
################################################################################
mkdir -p $INSTALLPATH/shapes/dia-ocarina6/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina6/*.png   $INSTALLPATH/shapes/dia-ocarina6/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina6/*.shape $INSTALLPATH/shapes/dia-ocarina6/
