...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina6/*.png   $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina6/*.shape $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6/
